...
(function (root, factory) {
    ...
    var inter = {
        ...
        renderCurrencyLong: function (value, currencyId, numberSystemId, numDecimals) {
            ...
            numberSystemId = numberSystemId || 'latn';
            numDecimals = typeof numDecimals === 'number' ? parseInt(numDecimals) : undefined;
        ...
        renderCurrency: function (value, currencyId, numberSystemId, numDecimals) {
            numberSystemId = numberSystemId || 'latn';
            numDecimals = typeof numDecimals === 'number' ? parseInt(numDecimals) : undefined;

            var currencyString = inter.applySpacingToCurrencyString(currencyId, this.numbers[numberSystemId].formats.currency, numberSystemId);
