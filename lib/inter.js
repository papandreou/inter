...
(function (root, factory) {
    ...
    var inter = {
        ...
        makePercentageRenderer: function (numDecimals, numberSystem) {
            return new Function("num", "return " + this.makeNumberRendererSource("100*num", numDecimals, "", " " + this.numberSymbols[numberSystem || this.defaultNumberSystem].percentSign) + ";");
        },
        ...
        makeNumberRendererSource: function (sourceVariableNameOrExpression, numDecimals, prefix, suffix, numberSystem) {
            var numberSymbols = this.numberSymbols[numberSystem || this.defaultNumberSystem];
