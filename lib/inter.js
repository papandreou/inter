                    ...
                    z: [
                        function () {
                            ...
                            return '({date}.getTimezoneOffset() < 0 ? ' +
                                    this.makeDateFormatRendererSource('new Date(1970, 0, 1, 0, -{date}.getTimezoneOffset())', this.timeZoneFormats.hour[0]) + ':' +
                                    this.makeDateFormatRendererSource('new Date(1970, 0, 1, 0, {date}.getTimezoneOffset())', this.timeZoneFormats.hour[1]) + ')';
                        }
                    ]
