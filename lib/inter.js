...
(function (root, factory) {
    ...
    var inter = {
         ...
         * to use instead of '¤'.
         */
        makeNumberRenderer: function (pattern, currencyCode, numberSystemId) {
            ...
            function subformatFixed(number, minIntDigits, parts) {
                ...
                var decimal = numberSystem.symbols.decimal,
                    ...
                    zeroCode = numberSystem.digits[0].charCodeAt(0),
            ...
            function addExponentPart(exponent, parts) {
                ...
                var exponentDigits = '' + exponent,
                    zeroChar = numberSystem.digits[0];
            ...
            function getDigit(ch) {
                ...
                if (48 <= code && code < 58) {
                    ...
                    var zeroCode = numberSystem.digits[0].charCodeAt(0);
