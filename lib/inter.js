...
(function (root, factory) {
    ...
    var inter = {
        ...
        makeDateRenderer: function (formatId, calendarId) {
            return new Function("d", "if (!d || !d.getHours) { if (d._time) { var icalJsDate = d; d = {getTimezoneOffset: function () {return -icalJsDate.utcOffset()/60;}, getTime: function () {return icalJsDate.toUnixTime()*1000}, getDay: function () {return icalJsDate.dayOfWeek() - 1;}, getFullYear: function () {return icalJsDate._time.year;}, getMonth: function () {return icalJsDate._time.month - 1;},getDate: function () {return icalJsDate._time.day;},getHours: function () {return icalJsDate._time.hour;},getMinutes: function () {return icalJsDate._time.minute;},getSeconds: function () {return icalJsDate._time.second;}}; } else { d = new Date(d); } }return " + this.makeDateFormatRendererSource("d", this.getDateFormat(formatId, calendarId), calendarId) + ";");
        },
