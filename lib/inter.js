...
(function (root, factory) {
    ...
    var inter = {
        ...
        makeDateRenderer: function (formatId, calendarId) {
            return new Function("d", "if (!d || !d.getHours) { if (d._time) { d = new Date(d._time.year, d._time.month - 1, d._time.day, d._time.hour, d._time.minute, d._time.second, d._time.isDate); } else { d = new Date(d); } }return " + this.makeDateFormatRendererSource("d", this.getDateFormat(formatId, calendarId), calendarId) + ";");
        },
