...
(function (root, factory) {
    ...
    var inter = {
        ...
        renderCurrencyLong: function (value, currencyId, numberSystemId) {
            ...
            return this.renderNumber(value, this.numbers[numberSystemId].formats.currency.default, numberSystemId, currencyString);
        },
        ...
        renderCurrencyShort: function (value, currencyId, numberSystemId) {
            ...
            var renderedCurrency = this.renderNumber(value, this.numbers[numberSystemId].formats.currency.default, numberSystemId, currencyString),
                currencySpacing = this.numbers[numberSystemId].formats.currency.currencySpacing;

            // Apply beforeCurrency

            renderedCurrency.replace(new RegExp('(' + currencySpacing.beforeCurrency.surroundingMatch.source + ')(' + currencySpacing.beforeCurrency.currencyMatch.source + ')'), function ($0, surroundingMatched, currencyMatched) {
                return surroundingMatched + currencySpacing.insertBetween + currencyMatched;
            });

            renderedCurrency.replace(new RegExp('(' + currencySpacing.beforeCurrency.currencyMatch.source + ')(' + currencySpacing.beforeCurrency.surroundingMatch.source + ')'), function ($0, currencyMatched, surroundingMatched) {
                return currencyMatched + currencySpacing.insertBetween + surroundingMatched;
            });
