...
(function (root, factory) {
    ...
    var inter = {
         ...
         */
        makeNumberRenderer: function (numDecimals, factor, prefix, suffix, numberSystemId) {
            return new Function("num",
                                "return " +
                                    this.makeNumberRendererSource((typeof factor === 'undefined' ? '' : "" + factor + "*") + "num", numDecimals, prefix, suffix, numberSystemId) + ";");
        },
        ...
        makePercentageRenderer: function (numDecimals, numberSystemId) {
            return new Function("num", "return " + this.makeNumberRendererSource("100*num", numDecimals, "", " " + this.numbers[numberSystemId || this.defaultNumberSystemId].symbols.percentSign) + ";");
        },
        ...
        makeFileSizeRenderer: function (numDecimals, numberSystemId) {
            return new Function("size",
                                "if (size < 1000) {" +
                                    "return " + this.makeNumberRendererSource("size", 0, "", " bytes", numberSystemId) + ";" +
                                "} else if (size < 1000000) {" +
                                    "return " + this.makeNumberRendererSource("size/1024", numDecimals, "", " KB", numberSystemId) + ";" +
                                "} else if (size < 1000000000) {" +
                                    "return " + this.makeNumberRendererSource("size/1048576", numDecimals, "", " MB", numberSystemId) + ";" +
                                "} else if (size < 1000000000000) {" +
                                    "return " + this.makeNumberRendererSource("size/1073741824", numDecimals, "", " GB", numberSystemId) + ";" +
                                "} else {" +
                                    "return " + this.makeNumberRendererSource("size/1099511627776", numDecimals, "", " TB", numberSystemId) + ";" +
                                "}");
        },
         ...
         * @private
         */
        makeNumberRendererSource: function (sourceVariableNameOrExpression, numDecimals, prefix, suffix, numberSystemId) {
            ...
            if (greatestDifferences) {
                ...
                if (datePartOnly && matchFormatId) {
                    ...
                    return this.getPatternRenderer(this.calendars[calendarId].dateIntervalFallbackFormat,
                                                   this.makeDateFormatRendererSource('values.start', dateFormat, calendarId),
                                                   this.makeDateFormatRendererSource('values.end', dateFormat, calendarId));
                }
            }
        },
