    ...
    var inter = {
        ...
        makeFileSizeRenderer: function (numDecimals, numberSystemId) {
            ...
            return new Function("size",
                                "if (size < 1000) {" +
                                    "return " + makeNumberRendererSource("size", 0, "\xa0bytes", numberSystemId) + ";" +
                                "} else if (size < 1000000) {" +
                                    "return " + makeNumberRendererSource("size/1024", numDecimals, "\xa0KB", numberSystemId) + ";" +
                                "} else if (size < 1000000000) {" +
                                    "return " + makeNumberRendererSource("size/1048576", numDecimals, "\xa0MB", numberSystemId) + ";" +
                                "} else if (size < 1000000000000) {" +
                                    "return " + makeNumberRendererSource("size/1073741824", numDecimals, "\xa0GB", numberSystemId) + ";" +
                                "} else {" +
                                    "return " + makeNumberRendererSource("size/1099511627776", numDecimals, "\xa0TB", numberSystemId) + ";" +
                                "}");
        },
        ...
        makeDateNormalizerSource: function (variableName) {
            ...
            // Don't break if the source has been uglified:
